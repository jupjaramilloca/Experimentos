...
El tipo de invernadero y la ladera también son un factor que se debe tener en cuenta. Contamos con un invernadero situado en el corregimiento San José en el municipio de la Ceja Antioquia, este tiene cincuenta metros de largo y diez metros de ancho, se encuentra ubicado en una ladera con una pendiente que se desconoce, pero aparentemente se evidencia que es una ladera.

El objetivo es encontrar evidencia de que tanto para la humedad y la temperatura puedan variar dentro del invernadero por la razón de que la temperatura se puede concentrar en el lugar más alto del invernadero y a su vez afectar la humedad o la altura del techo. Entonces podríamos encontrar diferencias de temperaturas en diferentes alturas.
...
Tomando registros del máximo y el mínimo de la temperatura en la noche y en el día, en periodos de veinticuatro horas al igual que la humedad. Estos datos serán recolectados por medio de una planilla donde se encuentra la fecha, la zona del invernadero, el máximo y el mínimo de la temperatura, humedad y el periodo (Diurno o Nocturno). Con estos datos y herramientas estadísticas podemos llegar a conclusiones que nos ayudaran a tomar decisiones por ejemplo al ordenar las unidades experimentales en bloques que podría ser en los distintas alturas.



### Simulación: 

Esta simulación es para la temperatura Diurna, los datos son pre establecidos para tener una idea de la vizualización.
...
Esta grafica es una opción aunque se debe mejorar, muestra el cambio de temperatura en las tres zonas , en el lado izquierdo podemos observar una paleta de color azul mostrando que el color azul oscuro es la temperatura más fría y el azul claro la temperatura más caliente. Cada cambio de color representa cada día que pasa
...
Este grafico de cajas y lingotes nos muestra la variabilidad en cada zona, observamos que en la zona C se encuentra más variabilidad de la temperatura diurna y nocturna, la zona A y B nocturna muestran un comportamiento similar mientras que en la diurna todo lo contrario.
